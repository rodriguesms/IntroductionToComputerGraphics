...
let gate = new Image();
gate.src = doomCanvas1;

let chess = new Image();
chess.src = chessPattern;

let lowRes = new Image();
lowRes.src = low_res;

let lowRes2 = new Image();
lowRes2 = low_res_chess;


let textureCanvas1 = new THREE.Texture(gate);
let textureCanvas2 = new THREE.Texture(chess);


gate.onload = () => {
  textureCanvas1.needsUpdate = true;
  textureCanvas1.magFilter = THREE.NearestFilter; // filtro a ser utilizado em caso de magnificação.
  textureCanvas1.minFilter = THREE.NearestFilter; // filtro a ser utilizado em caso de minificação.
  textureCanvas1.anisotropy = 1; // fator máximo de anisotropia para o filtro anisotrópico.
...
chess.onload = function() {
    ...
    textureCanvas2.magFilter = THREE.NearestFilter; // filtro a ser utilizado em caso de magnificação.
    textureCanvas2.minFilter = THREE.NearestFilter; // filtro a ser utilizado em caso de minificação.
    textureCanvas2.anisotropy = 1; // fator máximo de anisotropia para o filtro anisotrópico.
    textureCanvas2.wrapS = THREE.RepeatWrapping;
    textureCanvas2.wrapT = THREE.RepeatWrapping;
};
